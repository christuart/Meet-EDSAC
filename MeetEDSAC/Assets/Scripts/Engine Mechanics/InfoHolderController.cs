...
public enum InformationContent { INTRODUCTION, INITIAL_ORDERS, MEMORY_STORAGE, DIVISION, ORDER_CODES, WORD_LENGTH, ACCUMULATOR, SCALING, COMPUTATION_SPEED, STORY_ONE, NONE };
